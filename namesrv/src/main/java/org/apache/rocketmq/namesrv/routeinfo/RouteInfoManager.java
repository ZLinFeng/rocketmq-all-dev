...
public class RouteInfoManager {
    ...
    /**
     * 记录topic的队列分布在哪些broker上,每个broker上存在该主题的队列个数
     * QueueData里的描述数据:  brokerName:broker名称 | readQueueNums:读队列个数 | writeQueueNums:写队列个数
     * | perm:权限操作 | topicSynFlag:同步复制还是异步复制
     */
    private final HashMap<String/* topic */, List<QueueData>> topicQueueTable;
    /**
     * broker信息
     * BrokerData里的描述数据:  cluster:broker所属集群 | brokerName:broker name |
     * HashMap<Long, String> brokerAddrs:记录brokerId和对应的IP:Port, brokerId=0表示Master,大于0表示Slave
     */
    private final HashMap<String/* brokerName */, BrokerData> brokerAddrTable;
    private final HashMap<String/* clusterName */, Set<String/* brokerName */>> clusterAddrTable;
    /**
     *当前存活的broker
     * BrokerLiveInfo里的描述数据:  lastUpdateTimestamp:最近更新时间 | dataVersion | channel:连接管道 | haServerAddr: HA地址
     */
