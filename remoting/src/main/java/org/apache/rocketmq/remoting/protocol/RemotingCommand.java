...
public class RemotingCommand {
    ...
    public ByteBuffer encode() {
        ...
        /**
         * 协议组成的第二部分,首先得到消息头,再加上该消息长度数4个字节
         */
        ...
        // length
        /**
         * 字节缓冲区中写入第一部分Int类型的消息总长度
         */
        result.putInt(length);

        // header length
        /**
         * 字节缓冲区中写入第二部分  序列化类型&&头长度
         */
    ...
    private byte[] headerEncode() {
        // 将消息头中自定义的字段写入 extFields
        this.makeCustomHeaderToNet();
        // 判断目前采用的序列化方式 主要看下json, 编码 RemotingCommand 为json格式,返回编码后的字节数组
